...
api_key = "a0076a2ada2f5cac32be52682324e11e"
...
def get_movie_tv_genre():
    movie_genre_req = requests.get(
        "https://api.themoviedb.org/3/genre/movie/list?api_key=a0076a2ada2f5cac32be52682324e11e&language=en-US").json()
    tv_genre_req = requests.get(
        "https://api.themoviedb.org/3/genre/tv/list?api_key=a0076a2ada2f5cac32be52682324e11e&language=en-US").json()
